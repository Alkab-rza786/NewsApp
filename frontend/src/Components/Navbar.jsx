            ...
            <div className="bg-white py-2">
                <div className="container mx-auto px-4">
                    <div className="flex space-x-6 overflow-x-auto scrollbar-hide md:justify-center">
                        ...
                        <Link to='/national' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">National</Link>
                        <Link to='/global' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Global</Link>
                        <Link to='/politics' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Politics</Link>
                        <Link to='/technologies' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Technologies</Link>
                        <Link to='/sports' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Sports</Link>
                        <Link to='/business' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Business</Link>
                        <Link to='/health' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Health</Link>
                        <Link to='/entertainment' className="text-gray-600 hover:text-blue-600 whitespace-nowrap">Entertainment</Link>
                    </div>
                </div>
            </div>
        </nav>
